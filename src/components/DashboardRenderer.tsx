          ...
          <LineChart data={data} margin={{ top: 20, right: 30, left: 0, bottom: 20 }}>
            ...
            {mapping.metrics.map((metricKey, index) => (
              <Line
                ...
                strokeWidth={3}
                dot={{ r: 5, fill: GENERIC_PALETTE[index % GENERIC_PALETTE.length], stroke: GENERIC_PALETTE[index % GENERIC_PALETTE.length], strokeWidth: 0 }}
                activeDot={{ r: 7, fill: GENERIC_PALETTE[index % GENERIC_PALETTE.length], stroke: GENERIC_PALETTE[index % GENERIC_PALETTE.length] }}
              />
            ))}
          </LineChart>
        );
